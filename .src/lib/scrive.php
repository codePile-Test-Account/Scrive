...
class scrive
{
    ...
    public function __construct()
    {
        ...
        $twig_vars = array(
            ...
            'core_css'      => $settings['base_url'] . '/' . '.src/lib/modules/css-helpers',
            'core_js'       => $settings['base_url'] . '/' . '.src/lib/modules/js-helpers',
            'core_tpl'      => $settings['base_url'] . '/' . '.src/lib/modules/tpl-helpers',
