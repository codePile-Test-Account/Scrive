...
class scrive
{
    ...
    public function __construct()
    {
        ...
        $twig_vars = array(
            ...
            'core_css'      => $settings['base_url'] . '/' . '.scrive/modules/css-helpers',
            'core_js'       => $settings['base_url'] . '/' . '.scrive/modules/js-helpers',
            'core_tpl'      => $settings['base_url'] . '/' . '.scrive/modules/tpl-helpers',
